...
def about():
    showinfo(title="Hakkında",message="Ortalama Hesaplayıcı v0.1ARCH",detail="2012 Berat Alp Erbil-beratalp@goldos.org\nBu program GNU/GPLv3 Lisansıyla lisanslanmıştır.")
def calculate():
    try:
...
MainWindow = Tk()
MainWindow.title("Ortalama Hesaplayıcı v0.1ARCH")
